...
?>
    ...
    <script type="text/javascript">
        ...
        function startWatch() {
            ...
            x.innerHTML = 'Elapsed Time: ' + gethours + mins + secs;
...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            <a class="navbar-brand" href="javascript:logoutview();">"<?php echo $_GET['name']; ?>" Live Streaming</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li class="page-scroll active">
                    <a href="javascript:logoutview();">Back to list</a>

                </li>
                <li class="page-scroll logout">
                    <a href="javascript:destroy_session();">Logout</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
        ...
        <li class="jsxc_windowItem jsxc_min_c jsxc_groupchat" data-bid="demo@conference.153.126.152.115">
            <div class="jsxc_window_c" style="bottom: 0px;">
                ...
                <div class="jsxc_fade">
                    ...
                    <textarea class="jsxc_textinput" data-i18n="[placeholder]Comments" placeholder="Commenting isn't ready yet" disabled></textarea>
                </div>
            </div>
        </li>
    </ul>
