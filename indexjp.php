...
if(isset($_SESSION['USERNAME'])){
    header("Location:streamlistjp.php");
    exit;
}
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand" href="">ライブチャット</a>
            </div>
        </div>
        <!-- /.container-fluid -->
    </nav>
            ...
            <div id="" class="col-sm-4 col-xs-offset-4">
                <div id="login">
                    <form action="" method="post">
                        <label>ユーザー名  :</label>
                        <input type="text" name="username" id="username" placeholder="ユーザー名"/><br /><br />
                        <label>パスワード  :</label>
                        <input type="password" name="password" id="password" placeholder="**********"/><br/><br />
                        <input type="button" value=" ログイン " name="submit" id="submit"/><br />
                        <span></span>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $('#submit').click(function(){
            ...
            if(bool){
                ...
                alert('このユーザーは既に他のデバイスでログインしています。別のユーザー名で試してください');
            }
        });
